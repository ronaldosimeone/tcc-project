    ...
    <Card className="border-slate-200">
      ...
      <CardContent className="flex flex-col items-center gap-3 px-4 pb-4">
        {isLoading || data.length === 0 ? (
          ...
          // legenda abaixo já traz nome + valor + % de cada fatia em texto
          // real — sem isso o Recharts 3.x expõe o <svg> como
          // tabIndex=0 role="application" sem nome acessível.
        ...
        <div className="grid w-full grid-cols-2 gap-x-3 gap-y-1">
          {(data.length > 0 ? data : OP_STATES).map((s) => (
